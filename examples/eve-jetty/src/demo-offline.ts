 ...
 * the other regressed. This is what the live run (`npm run ab-eval`) produces for
...
console.log("(simulated; run `npm run ab-eval` against a live `npx eve dev` for the real thing)\n");
